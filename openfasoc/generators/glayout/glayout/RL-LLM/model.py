...
class CircuitEnvironment:
    ...
    def step(self, action):
        ...
        """
        The following code runs the glayout generated by the LLM so a gds file is created
        ...
        self.enforcer.enforce(gds_file) # gds_file is a placeholder for the gds_file generated from running the glayout code of the LLM
    ...
    def generate_glayout(self, gds_file, action):
...
Todo: lots of stuff to fix with intereactions between enforcer.py and model.py
        ...
        updating the action type/space for the model
